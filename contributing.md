# Contributing to cordlr-cleverbot

First and foremost, thank you! We appreciate that you want to contribute to cordlr-cleverbot, your time is valuable, and your contributions mean a lot to us.
...
**Showing support for cordlr-cleverbot**

Please keep in mind that open source software is built by people like you, who spend their free time creating things the rest the community can use.

Don't have time to contribute? No worries, here are some other ways to show your support for cordlr-cleverbot:

- star the [project](https://github.com/seanc/cordlr-cleverbot)
- tweet your support for cordlr-cleverbot
...
- **version**: please note the version of cordlr-cleverbot are you using
...
[so]: http://stackoverflow.com/questions/tagged/cordlr-cleverbot